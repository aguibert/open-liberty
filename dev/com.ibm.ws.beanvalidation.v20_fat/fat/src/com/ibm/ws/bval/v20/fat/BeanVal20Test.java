...
public class BeanVal20Test extends FATServletClient {
    ...
    public static final String BASIC_APP = "bvalApp";
    public static final String CDI_APP = "bvalCDIApp";

    @Server("beanval.v20_fat")
    @TestServlets({
                    @TestServlet(servlet = BeanVal20TestServlet.class, contextRoot = BASIC_APP),
    ...
    public static void setUp() throws Exception {
        ShrinkHelper.defaultDropinApp(server, BASIC_APP, "bval.v20.web");
